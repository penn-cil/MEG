...
//    wire   [3:0]  spi_lite_b_id;     
  ...
  axi_lite_bridge spi_axi_lite_bridge(
    .aclk( clock ),
    .aresetn( resetn ),
    .s_axi_awid         ( spi_axi4_aw_id    ),
    .s_axi_awaddr       ( spi_axi4_aw_addr  ),
    .s_axi_awlen        ( spi_axi4_aw_len   ),
    .s_axi_awsize       ( spi_axi4_aw_size  ),
    .s_axi_awburst      ( spi_axi4_aw_burst ),
    .s_axi_awvalid      ( spi_axi4_aw_valid ),
    .s_axi_awready      ( spi_axi4_aw_ready ),
    .s_axi_arid         ( spi_axi4_ar_id    ),
    .s_axi_araddr       ( spi_axi4_ar_addr  ),
    .s_axi_arlen        ( spi_axi4_ar_len   ),
    .s_axi_arsize       ( spi_axi4_ar_size  ),
    .s_axi_arburst      ( spi_axi4_ar_burst ),
    .s_axi_arvalid      ( spi_axi4_ar_valid ),
    .s_axi_arready      ( spi_axi4_ar_ready ),
    .s_axi_wdata        ( spi_axi4_w_data   ),
    .s_axi_wstrb        ( spi_axi4_w_strb   ),
    .s_axi_wlast        ( spi_axi4_w_last   ),
    .s_axi_wvalid       ( spi_axi4_w_valid  ),
    .s_axi_wready       ( spi_axi4_w_ready  ),
    .s_axi_bid          ( spi_axi4_b_id     ),
    .s_axi_bresp        ( spi_axi4_b_resp   ),
    .s_axi_bvalid       ( spi_axi4_b_valid  ),
    .s_axi_bready       ( spi_axi4_b_ready  ),
    .s_axi_rid          ( spi_axi4_r_id     ),
    .s_axi_rdata        ( spi_axi4_r_data   ),
    .s_axi_rresp        ( spi_axi4_r_resp   ),
    .s_axi_rlast        ( spi_axi4_r_last   ),
    .s_axi_rvalid       ( spi_axi4_r_valid  ),
    .s_axi_rready       ( spi_axi4_r_ready  ),
    .m_axi_awaddr       ( spi_lite_aw_addr  ),
    .m_axi_awvalid      ( spi_lite_aw_valid ),
    .m_axi_awready      ( spi_lite_aw_ready ),
    .m_axi_araddr       ( spi_lite_ar_addr  ),
    .m_axi_arvalid      ( spi_lite_ar_valid ),
    .m_axi_arready      ( spi_lite_ar_ready ),
    .m_axi_wdata        ( spi_lite_w_data   ),
    .m_axi_wstrb        ( spi_lite_w_strb   ),
    .m_axi_wvalid       ( spi_lite_w_valid  ),
    .m_axi_wready       ( spi_lite_w_ready  ),
    .m_axi_bresp        ( spi_lite_b_resp   ),
    .m_axi_bvalid       ( spi_lite_b_valid  ),
    .m_axi_bready       ( spi_lite_b_ready  ),
    .m_axi_rdata        ( spi_lite_r_data   ),
    .m_axi_rresp        ( spi_lite_r_resp   ),
    .m_axi_rvalid       ( spi_lite_r_valid  ),
    .m_axi_rready       ( spi_lite_r_ready  )
  );
  
   wire [3:0]    spi_lite_w_strb_half;
   wire [31:0]   spi_lite_w_data_half;
   wire [31:0]   spi_lite_r_data_half; 
   narrower spi_narrower(
       .r_data_64  (spi_lite_r_data),
       .w_data_64  (spi_lite_w_data),
       .w_strb_8   (spi_lite_w_strb),
       .r_data_32  (spi_lite_r_data_half),
       .w_data_32  (spi_lite_w_data_half),
       .w_strb_4   (spi_lite_w_strb_half)
   );
...
//  Instance the spi controller IP
    ...
    axi_quad_spi_0 axi_spi_inst(
        ...
        .s_axi_awready  (spi_lite_aw_ready),
        .s_axi_awvalid  (spi_lite_aw_valid),
        .s_axi_awaddr   (spi_lite_aw_addr[6:0]),
        .s_axi_wready   (spi_lite_w_ready),
        .s_axi_wvalid   (spi_lite_w_valid),
        .s_axi_wdata    (spi_lite_w_data_half),
        .s_axi_wstrb    (spi_lite_w_strb_half),  // need to be reconsidered
        .s_axi_bready   (spi_lite_b_ready),
        .s_axi_bvalid   (spi_lite_b_valid),
        .s_axi_bresp    (spi_lite_b_resp),
        .s_axi_arready  (spi_lite_ar_ready),
        .s_axi_arvalid  (spi_lite_ar_valid),
        .s_axi_araddr   (spi_lite_ar_addr[6:0]),
        .s_axi_rready   (spi_lite_r_ready),
        .s_axi_rvalid   (spi_lite_r_valid),
        .s_axi_rdata    (spi_lite_r_data_half),
        .s_axi_rresp    (spi_lite_r_resp),
